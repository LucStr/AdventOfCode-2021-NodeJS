...
const loser = cards.reduce((a, b) => a.result.index > b.result.index ? a : b);
const numbersLeftOnBoard = loser.entries
    .reduce((a, b) => a.concat(...b), [])
    .filter(e => e.index > loser.result.index)
    .reduce((a, b) => a + b.number, 0)

console.log(loser.result.number * numbersLeftOnBoard);